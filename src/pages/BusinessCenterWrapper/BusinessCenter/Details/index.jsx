...
class Details extends Component {
    ...
    componentDidUpdate = (prevProps) => {
        const { formSyncErrors, submitFailed, formAsyncErrors = {} } = this.props;
        const prevErrorsLength =
            Object.keys(prevProps.formSyncErrors).length +
            Object.keys(prevProps.formAsyncErrors).length;

        const currentErrorsLength =
            Object.keys(formSyncErrors).length + Object.keys(formAsyncErrors).length;

        if (currentErrorsLength < prevErrorsLength && submitFailed) {
...
const mapStateToProps = (state) => {
    return {
        ...
        formAsyncErrors: getFormAsyncErrors('businessCenter')(state) || {},
